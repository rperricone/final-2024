...
class TokenService {
  ...
  async roleCheckInsides(allowedRolesOnThisRoute, returnOnReq, req, res, next) {
    // console.log(arguments, 'role check insides')
   ...
   * @returns 
   */
  async roleCheck(allowedRolesOnThisRoute, returnOnReq, req, res, next) {
